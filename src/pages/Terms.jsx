  ...
  return (
    <>
      <PageMeta
        ...
        description={`Terms of Use for ${siteName}, the audio waveform video maker for iOS.`}
        path="/terms"
      />
      <article className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <div>
          ...
          <Section title="3. Subscriptions (Osci Pro)">
            ...
            <ul>
              <li>
                Subscriptions are available on a monthly ($4.99) or yearly ($29.99)
                basis at the price displayed in the App Store for your region.
              </li>
              <li>
                The yearly plan includes a 7-day free trial for eligible new subscribers.
              </li>
              <li>
